...
export default function TechOrbit() {
  ...
  return (
    <div
      data-aos="zoom-in"
      data-aos-delay="200"
      className="max-[1024px]:w-full relative w-[60%] h-[400px] md:h-[500px] flex items-center justify-center overflow-hidden"
    >
      {/* Markazdagi doira */}
        ...
        {icons.map((el, index) => {
          ...
          return (
            <div
              ...
              style={
                {
                  // --radius o'zgaruvchisi orqali dinamik transform
                  transform: `rotate(${angle}deg) translate(var(--orbit-radius)) rotate(-${angle}deg)`,
                } as React.CSSProperties
              }
            >
              {/* Tailwind orqali mobil va desktop radiusni belgilash */}
              <style>{`
                :root { --orbit-radius: 130px; }
                @media (min-width: 768px) { :root { --orbit-radius: 175px; } }
              `}</style>
